...
class CommentTest {
    ...
    @Test
    @DisplayName("Comment should be immutable")
    void testCommentImmutability() {
        // Arrange
        Comment comment = new Comment("Original comment");
        LocalDateTime originalTime = comment.getCreationTime();

        // Act & Assert
        // All fields are final, immutability is guaranteed at compile-time
        assertEquals(originalTime, comment.getCreationTime());
    }
