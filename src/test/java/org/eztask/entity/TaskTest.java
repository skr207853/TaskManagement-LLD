...
class TaskTest {
    ...
    void testSetUpdatedAt() {
        ...
        // Assert
        // No getter for updatedAt in current implementation, but setter works
    ...
    void testAddMultipleComments() {
        ...
        // Assert - Comments are added successfully (no exception)
        assertDoesNotThrow(() -> {
            task.addComment(comment1);
            task.addComment(comment2);
        });
    ...
    void testConcurrentCommentAdditions() throws InterruptedException {
        ...
        // Assert - No exception should be thrown due to thread-safe implementation
        assertTrue(true);
    }
